...
class EnrollmentModel:
    ...
    def _create_table(self):
        ...
        self.db_conn.cursor.execute(
            ...
            CREATE TABLE IF NOT EXISTS matriculas (
                ...
                id_endereco INTENGER NOT NULL,
                data_matricula DATETIME DEFAULT CURRENT_TIMESTAMP,

                -- Chave primária composta (evita matrícula duplicada)
                PRIMARY KEY (id_aluno, id_curso, id_matricula),
    ...
    def get_courses_by_student(self, id_aluno): #BUSCAR CURSO PELOS ALUNOS
    ...
    def get_students_by_endereco(self, id_endereco):
        self.db_conn.connect()
        self.db_conn.cursor.execute(
              """
            SELECT a.id, a.nome, a.email, m.data_matricula

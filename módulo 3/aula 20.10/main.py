...
from alunos import StudentModel
...
def handle_student_management():
    ...
    while True:
        ...
        choice = input("Escolha uma opcao: ").upper()
        ...
        if choice == "1":
            ...
            student_model.create_student(nome, email, endereço)
            ...
            try:
                ...
                if student:
                    print("\nAluno encontrado:")
                    print(
                        f"ID: {student['id']} | Nome: {student['nome']} | E-mail: {student['email']} | Endereço: {'endereço'}"
                    )
                else:
